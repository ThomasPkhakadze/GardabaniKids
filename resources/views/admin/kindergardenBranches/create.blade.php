...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.kindergardenBranch.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.kindergarden-branches.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_manager') ? 'is-invalid' : '' }}" type="text" name="branch_manager" id="branch_manager" value="{{ old('branch_manager', '') }}" required>
