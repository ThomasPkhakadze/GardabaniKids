                ...
                <table class="table table-striped w-100">
                    <thead class="rounded-table-header">
                        <tr class="rounded-table-row">
                            <th class="rounded-table-heading-left"><p class="mb-0 ">Name</p></th>
                            <th>Position</th>
                            <th>Office</th>
                            <th>Age</th>
                            <th>Start date</th>
                            <th class="rounded-table-heading-right">Salary</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="rounded-table-heading-left position-relative"><p class="mb-0 ">Sonya Frost</p></td>
