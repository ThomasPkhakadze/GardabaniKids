<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('kindergarden_branch_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.kindergarden-branches.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/kindergarden-branches") || request()->is("admin/kindergarden-branches/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.kindergardenBranch.title') }}
                </a>
            </li>
        @endcan
        @can('kindergarden_group_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.kindergarden-groups.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/kindergarden-groups") || request()->is("admin/kindergarden-groups/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('kid_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.kids.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/kids") || request()->is("admin/kids/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('parent_guardian_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.parent-guardians.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/parent-guardians") || request()->is("admin/parent-guardians/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.parentGuardian.title') }}
                </a>
            </li>
        @endcan
